...
export default function AntrianObatScreen() {
  ...
  const loadAntrian = async () => {
    try {
      const res = await fetch('http://app.rsabojonegoro.com:5000/his/new/AntrianKORJ');
  ...
  useEffect(() => {
    loadAntrian();
    const timer = setInterval(loadAntrian, 10000);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Farmasi Rawat Jalan</Text>
      </View>
