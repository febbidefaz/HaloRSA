      ...
      <ScrollView style={styles.content}>
       ...
       <Text style={styles.label}>Perawatan</Text>
        ...
        <TextInput
            ...
            placeholder="Masukkan data sumber informasi"
            value={sumber}
            onChangeText={(text) => {
                setSumber(text);
        ...
        <TextInput
          ...
          placeholder="Ketikkan saran dan masukkan"
          value={saran}
        ...
        {showUnitModal && (
            ...
            >
                ...
                <View style={styles.modalHeader}>
                    ...
                    <Text style={styles.modalTitle}>Pilih Perawatan</Text>
                </View>
                ...
                <Animated.View
                    ...
                    >
                    <Ionicons name="chevron-up" size={14} color="#0A7C86" />
                    <View style={styles.scrollLine} />
                    <Ionicons name="chevron-down" size={14} color="#0A7C86" />
                </Animated.View> 
...
const styles = StyleSheet.create({
  ...
  modalScroll: {
    maxHeight: 360,
    paddingRight: 20, // 🔥 kasih ruang buat indikator
  },
